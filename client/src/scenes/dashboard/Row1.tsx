...
import {Tooltip, Area, AreaChart, ResponsiveContainer, XAxis, YAxis, Line, CartesianGrid, Legend, LineChart, BarChart, Bar } from 'recharts';
...
const Row1 = () => {
  ...
  const revenueExpenses = useMemo(() => {
    return (
      data && data[0].monthlyData.map(({month, expenses, revenue}) => {
        return (
          {
